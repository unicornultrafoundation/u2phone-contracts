...
//
// Solidity: function saleRounds(uint256 ) view returns(uint256 id, uint256 startTime, uint256 endTime, uint256 maxSupply, uint256 price, bool whitelistOnly, uint256 totalMinted, uint256 maxNFTPerWalletInRound)
