...
Deploy Launhpad (Deploy Collection, and set Max Supply)
...
- Step 6 : Verify With HardHat address in step 5 ⇒ change information in very-mint.js
- Step 7 : Set Operator in Collection With Address generation in Step 5. And increase maxSupply too
- Step 8: Test Flow Buy

- Round Zero ⇒ sẽ có 1 khoản thời gian để người dùng staking ⇒ Worker sẽ chạy job để add họ vào whiteList của launhpad.
- sau đó tới khi round được mở thì sẽ không thể add WhiteList và những account trong whiteList sẽ được mint.

```
[[2,99,1723694400,1724299200,0,136,0,2]] => ProjectManager => CreateRound

[2,99000000000000000000,1723694400,1724299200,0,136,0,2] => Deployer
...
[true,false,false,0x0DfCd1875DF81Ee42815475942BB83101f957300,0x2743eEC46576f76f47334569074242F3D9a90B44]
...
collectionAddress: '0x5ce32cDE213de3c074dF1c7Fc519adCCEce4Adce', 
